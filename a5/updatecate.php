  ...
  <nav id="top-bar" class="navbar navbar-expand-sm shadow">
    ...
    <div id="wrapper">
      <section class="header_text sub">
        <h4><span>Update a category</span></h4>
      </section>

      <form action="" method="POST" id="del-cform">
      <p style="font-size: 14px;">Change the name of a category here</p>
        <div class="form-group">
          <label>Current Name</label>
          <input type="text" name="oldc" value ="<?php echo isset($_POST['oldc']) ? $_POST['oldc'] : ''; ?>">
          <?php echo $oldcerr ?>
        </div>
        <div class="form-group">
          <label>New Category Name</label>
          <input type="text" name="newc" value ="<?php echo isset($_POST['newc']) ? $_POST['newc'] : ''; ?>">
          <?php echo $newcerr ?>
        </div>
        <div class="form-group">
          <input class="btn btn-primary btn-dark" type="submit" name="updatecategory" value="Update Category">
        </div>
      </form>
    </div>
    <footer>
